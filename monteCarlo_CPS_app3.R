...
#pre processing
setwd("C:/Users/CORE_DM/Desktop/edgar/rasters/all_in_one/csv_app3/")
...
idx <- ffwhich(file,classification == 1)

negative <- file[idx,]

idx <- ffwhich(file,classification == 0)
...
write.csv(df_pos, 'C:/Users/CORE_DM/Dropbox/upch/TDR_approaches_data/CPS_pos.csv')
...
write.csv(df_neg, 'C:/Users/CORE_DM/Dropbox/upch/TDR_approaches_data/CPS_neg.csv')
